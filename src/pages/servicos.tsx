    ...
    return (
        <>
            <Head>
                ...
                <meta name="keywords" content="serviços de engenharia civil, projetos de arquitetura Belém, gerenciamento de obras, reformas, construção, design de interiores Belém, laudo técnico, projetos estruturais, paisagismo, Livre de Multas" />
                ...
                <meta name="twitter:title" content="Serviços Livre de Multas" />
            ...
            <div className="min-h-screen flex flex-col">
                ...
                <main className="flex-grow">
                    ...
                    />
                    <SubtitlePage text="Na Livre de Multas, unimos expertise técnica e inovação para entregar projetos que transformam ambientes e superam expectativas. Atuamos em múltiplos segmentos, garantindo soluções personalizadas e de alta qualidade para cada necessidade." />
                    <ServicosComponent />
                    <ParallaxBanner

    ...
    return (
        <>
            <Head>
                ...
                <meta name="keywords" content="serviços de engenharia civil, projetos de arquitetura Belém, gerenciamento de obras, reformas, construção, design de interiores Belém, laudo técnico, projetos estruturais, paisagismo, Pereira de Sousa Associados" />
                ...
                <meta name="twitter:title" content="Serviços Pereira de Sousa Associados" />
            ...
            <div className="min-h-screen flex flex-col">
                ...
                <main className="flex-grow">
                    ...
                    />
                    <SubtitlePage text="Na Pereira de Sousa Associados, unimos expertise técnica e inovação para entregar projetos que transformam ambientes e superam expectativas. Atuamos em múltiplos segmentos, garantindo soluções personalizadas e de alta qualidade para cada necessidade." />
                    <ServicosComponent />
                    <ParallaxBanner

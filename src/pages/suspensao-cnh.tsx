          ...
          <main className="relative py-6">
                  ...
                  <div className="mt-6 grid gap-3">
                    <div className="flex items-start gap-3 text-gray-200">
                      ...
                      <p className="leading-relaxed">
                        Descubra <strong className="text-white">em que fase</strong> está o processo (instauração vs.
                        penalidade).
                      </p>
                    </div>
                    <div className="flex items-start gap-3 text-gray-200">
              ...
              <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                <div>
                  ...
                  <p className="mt-1 text-gray-200">
                    Envie <strong className="text-white">foto da notificação</strong> +{" "}
            ...
            <section id="como-funciona" className="mt-12 mx-auto w-full max-w-6xl px-4 space-y-6">
              <h2 className="text-2xl font-extrabold text-white md:text-3xl">
                Quando a suspensão vira risco real?
              </h2>
                    ...
                    <ul className="space-y-2">
                      <li className="flex items-start gap-3">
                        ...
                        <span className="text-white">
                          Leia com atenção se a notificação é de <strong>instauração</strong> ou{" "}
                ...
                <div className="rounded-3xl border border-white/10 bg-white/5 p-6 backdrop-blur-sm">
                  ...
                  <div className="mt-4 space-y-3 text-gray-200">
                    ...
                    <div className="flex items-start gap-3 rounded-2xl border border-white/10 bg-black/20 p-4">
                      <IconAlert />
                      <p className="leading-relaxed">
                        Confundir <strong className="text-white">multa</strong> com{" "}
                        <strong className="text-white">processo de suspensão</strong>.
                      </p>
                    </div>
                  </div>
                </div>
            ...
            {/* =========================
                PRINCIPAIS CAUSAS + SUBITENS (COM ÂNCORAS)
               ========================= */}
            <section id="causas" className="mt-12 mx-auto w-full max-w-6xl px-4">
              <h2 className="text-2xl font-extrabold text-white md:text-3xl">Principais causas de suspensão</h2>
              <p className="mt-2 text-gray-200 max-w-3xl">
                Abaixo estão alguns cenários comuns que podem abrir processo de suspensão. Clique em{" "}
                <strong className="text-white">Ver detalhes</strong> para ir direto ao tópico.
              </p>
              ...
              <div className="mt-6 grid gap-4 md:grid-cols-3">
                {[
                  ...
                  >
                    ...
                    <p className="mt-2 text-gray-200 leading-relaxed">{item.desc}</p>

                    <a
                      href={item.href}
                      className="mt-5 inline-flex items-center gap-2 text-sm font-semibold text-[#fec655] hover:opacity-90"
                    >
              ...
              {/* DETALHE 1 */}
              <section id="excesso-velocidade-50" className="mt-10 rounded-3xl border border-white/10 bg-white/5 p-6 shadow-2xl backdrop-blur-sm">
                <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                  <h3 className="text-xl font-extrabold text-white">
                    Excesso de velocidade acima de 50% <span className="text-[#fec655]">(detalhes)</span>
                  </h3>
                  <a href="#causas" className="text-sm text-gray-200 hover:text-[#fec655]">
                    Voltar para causas ↑
                  </a>
                </div>

                <p className="mt-3 text-gray-200 leading-relaxed">
                  Casos de autuação por alta velocidade que podem gerar suspensão. Aqui, o foco é entender{" "}
                  <strong className="text-white">qual foi o enquadramento</strong>, como foi feita a medição e se o{" "}
                  <strong className="text-white">procedimento</strong> (notificações/prazos) está regular.
                </p>

                <div className="mt-5 grid gap-4 md:grid-cols-2">
                  <div className="rounded-2xl border border-white/10 bg-black/20 p-5">
                    <h4 className="font-bold text-[#fec655]">O que analisar</h4>
                    <ul className="mt-3 space-y-2 text-gray-200">
                      <li className="flex items-start gap-3"><IconCheck /><span>Se a notificação é de <strong className="text-white">autuação</strong> ou <strong className="text-white">penalidade</strong>.</span></li>
                      <li className="flex items-start gap-3"><IconCheck /><span>Dados do auto: local, horário, placa, tipo de via e limite indicado.</span></li>
                      <li className="flex items-start gap-3"><IconCheck /><span>Se existem inconsistências entre velocidade medida/considerada e o enquadramento.</span></li>
                      <li className="flex items-start gap-3"><IconCheck /><span>Regularidade do procedimento e <strong className="text-white">prazos</strong> para defesa/recurso.</span></li>
                    </ul>
                  </div>

                  <div className="rounded-2xl border border-white/10 bg-black/20 p-5">
                    <h4 className="font-bold text-[#fec655]">Documentos para separar</h4>
                    <ul className="mt-3 space-y-2 text-gray-200">
                      <li className="flex items-start gap-3"><IconDoc /><span>CNH e documento com foto</span></li>
                      <li className="flex items-start gap-3"><IconDoc /><span>CRLV do veículo</span></li>
                      <li className="flex items-start gap-3"><IconDoc /><span>Notificação(ões) e número do auto</span></li>
                      <li className="flex items-start gap-3"><IconDoc /><span>Qualquer prova do dia (se houver): recibos, localização, etc.</span></li>
                    </ul>
                  </div>
                </div>
              </section>
              ...
              {/* DETALHE 2 */}
              <section id="manobras-perigosas-racha" className="mt-6 rounded-3xl border border-white/10 bg-white/5 p-6 shadow-2xl backdrop-blur-sm">
                <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                  <h3 className="text-xl font-extrabold text-white">
                    Manobras perigosas / racha <span className="text-[#fec655]">(detalhes)</span>
                  </h3>
                  <a href="#causas" className="text-sm text-gray-200 hover:text-[#fec655]">
                    Voltar para causas ↑
                  </a>
                ...
                <p className="mt-3 text-gray-200 leading-relaxed">
                  Situações enquadradas como direção perigosa e disputas costumam gerar procedimentos mais sensíveis.
                  O essencial é mapear <strong className="text-white">o enquadramento</strong>, a descrição do fato e se
                  existem <strong className="text-white">provas</strong> (ou ausência delas) que impactem a defesa.
                </p>
                ...
                <div className="mt-5 grid gap-4 md:grid-cols-2">
                  <div className="rounded-2xl border border-white/10 bg-black/20 p-5">
                    <h4 className="font-bold text-[#fec655]">O que analisar</h4>
                    <ul className="mt-3 space-y-2 text-gray-200">
                      <li className="flex items-start gap-3"><IconCheck /><span>Qual a descrição no auto e se há inconsistências no relato.</span></li>
                      <li className="flex items-start gap-3"><IconCheck /><span>Se existe material probatório (imagens, vídeos, testemunhas) e como foi formalizado.</span></li>
                      <li className="flex items-start gap-3"><IconCheck /><span>Se você foi notificado corretamente e está dentro do prazo para defesa/recurso.</span></li>
                      <li className="flex items-start gap-3"><IconCheck /><span>Se houve abordagem/identificação e se os dados foram corretamente preenchidos.</span></li>
                    </ul>
                  </div>
                  ...
                  <div className="rounded-2xl border border-white/10 bg-black/20 p-5">
                    <h4 className="font-bold text-[#fec655]">Documentos para separar</h4>
                    <ul className="mt-3 space-y-2 text-gray-200">
                      <li className="flex items-start gap-3"><IconDoc /><span>CNH e CRLV</span></li>
                      <li className="flex items-start gap-3"><IconDoc /><span>Notificações do processo e número do auto</span></li>
                      <li className="flex items-start gap-3"><IconDoc /><span>Comprovantes do local/horário (se houver)</span></li>
                      <li className="flex items-start gap-3"><IconDoc /><span>Qualquer evidência disponível (prints, vídeos, registros) — se existir</span></li>
                    </ul>
                  </div>
                </div>
              </section>
              ...
              {/* DETALHE 3 */}
              <section id="moto-sem-capacete" className="mt-6 rounded-3xl border border-white/10 bg-white/5 p-6 shadow-2xl backdrop-blur-sm">
                <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                  <h3 className="text-xl font-extrabold text-white">
                    Multa sem capacete <span className="text-[#fec655]">(detalhes)</span>
                  </h3>
                  <a href="#causas" className="text-sm text-gray-200 hover:text-[#fec655]">
                    Voltar para causas ↑
                  </a>
                ...
                <p className="mt-3 text-gray-200 leading-relaxed">
                  Autuação por condução sem capacete pode gerar processo conforme o enquadramento e o histórico.
                  Aqui, normalmente a análise passa por <strong className="text-white">regularidade do auto</strong>,
                  identificação, notificações e prazos.
                </p>
                ...
                <div className="mt-5 grid gap-4 md:grid-cols-2">
                  <div className="rounded-2xl border border-white/10 bg-black/20 p-5">
                    <h4 className="font-bold text-[#fec655]">O que analisar</h4>
                    <ul className="mt-3 space-y-2 text-gray-200">
                      <li className="flex items-start gap-3"><IconCheck /><span>Se há identificação clara do condutor e consistência no auto.</span></li>
                      <li className="flex items-start gap-3"><IconCheck /><span>Local, horário e circunstâncias registradas (e se batem com a realidade).</span></li>
                      <li className="flex items-start gap-3"><IconCheck /><span>Notificações: entrega/ciência e prazos para defesa/recurso.</span></li>
                      <li className="flex items-start gap-3"><IconCheck /><span>Se existe possibilidade de indicação de condutor (quando aplicável) e prazo.</span></li>
                    </ul>
                  </div>
                  ...
                  <div className="rounded-2xl border border-white/10 bg-black/20 p-5">
                    <h4 className="font-bold text-[#fec655]">Documentos para separar</h4>
                    <ul className="mt-3 space-y-2 text-gray-200">
                      <li className="flex items-start gap-3"><IconDoc /><span>CNH/CRLV</span></li>
                      <li className="flex items-start gap-3"><IconDoc /><span>Notificação(ões) e número do auto</span></li>
                      <li className="flex items-start gap-3"><IconDoc /><span>Provas do dia (se houver): recibos, localização, etc.</span></li>
                      <li className="flex items-start gap-3"><IconDoc /><span>Documentos do condutor real (se for o caso)</span></li>
                    </ul>
                  </div>
                </div>
              </section>
